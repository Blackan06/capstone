...
namespace OpenAI
{
    public class ChatGPT : MonoBehaviour
    {
        ...
        [SerializeField] private string apiKey; // S? d?ng SerializeField ?? truy c?p t? Inspector
        ...
        private async void SendReply()
        {
            try
            {
                ...
                */
                ...
                bool isDuplicate = generatedQuestions.Contains(question);
                // N?u câu h?i b? trùng l?p, th? sinh l?i câu h?i m?i cho ??n khi không còn trùng l?p
                while (isDuplicate)
                {
                    SendReply();
                    isDuplicate = generatedQuestions.Contains(question);
                }

                // L?u câu h?i vào danh sách các câu h?i ?ã sinh ra
                generatedQuestions.Add(question);
                // Hi?n th? câu h?i m?i trên giao di?n
