...
public class ChatGPTReception : MonoBehaviour
{
    ...
    private void Start()
    {
        apiKey = PlayerPrefs.GetString("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");
        organization = PlayerPrefs.GetString("org-n1DjPx0nSKpTWSuXikLIfJGO");
